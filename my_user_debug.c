...
void main(int argc, char **argv) {
    ...
    printf("Trying to request kernel for debug info about structure: %s", argv[0]);
    ...
    if (option == PCI_DEV_OPTION) {
        ...
        struct pci_parameters pci_params = { &pci_dev, argv[2], argv[3] };
        ...
        struct thread_parameters thread_params = { &thread, argv[2] };
